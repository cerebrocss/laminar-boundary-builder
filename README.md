...
![Annotate 页面：选择脑区、半球或已有 mask](docs/images/ui-01-annotate.png)

脑区提取和 3D shell 构建过程中，页面会显示当前进度。
...
![3D shell 标注：红线是闭合边界，左侧显示已经命名并选择 seed 的 surface](docs/images/ui-02-surface-selection.png)
...
![Build 页面：确认 mask 和项目输出目录后计算 laminar depth](docs/images/ui-03-build.png)
